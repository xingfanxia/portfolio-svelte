...
/**
 * Item in *Experiences → Default → Primary → Item*
 */
export interface ExperiencesSliceDefaultPrimaryItemsItem {
	/**
	 * Title field in *Experiences → Default → Primary → Item*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	...
	/**
	 * Time Period field in *Experiences → Default → Primary → Item*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	...
	/**
	 * Institution field in *Experiences → Default → Primary → Item*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	...
	/**
	 * Institution Link field in *Experiences → Default → Primary → Item*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: experiences.default.primary.items[].institution_link
	 * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
	 */
	institution_link: prismic.LinkField;

	/**
	 * Description field in *Experiences → Default → Primary → Item*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
...
export interface ExperiencesSliceDefaultPrimary {
	...
	/**
	 * Item field in *Experiences → Default → Primary*
	 *
	 * - **Field Type**: Group
	 * - **Placeholder**: *None*
